  ...
  return (
    <>
      ...
      <button
        ...
        className="flex h-9 w-9 items-center justify-center rounded-lg border border-slate-700 bg-slate-800/80 text-slate-400 hover:text-slate-200 md:hidden"
      ...
      {isOpen && (
        <div className="fixed inset-0 z-50 md:hidden">
          ...
          {/* Drawer */}
          <div className="absolute left-0 top-0 bottom-0 w-72 flex flex-col bg-slate-900 border-r border-slate-800 shadow-2xl">
            {/* Drawer header */}
